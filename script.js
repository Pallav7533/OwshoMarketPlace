...
class ManualCarousel {
    ...
    getVisibleCardCount() {
        ...
        const cardWidth = this.scrollContainer.querySelector(this.cardSelector)?.offsetWidth || 300;
...
document.addEventListener('keydown', (e) => {
    ...
    if (e.key === 'ArrowLeft' || e.key === 'ArrowRight') {
        ...
        if (carousel) {
            e.preventDefault();
            const cardWidth = carousel.querySelector('.service-card, .testimonial-card')?.offsetWidth + 32 || 350;
...
console.log('🚀 Owsho Enhanced Website with Manual Swipe Functionality Loaded Successfully!');